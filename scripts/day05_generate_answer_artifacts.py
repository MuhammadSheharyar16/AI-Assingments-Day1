...
`data/day05_pack/answer_cases.json`, and writes `artifacts/day05/
...
exactly what `data/day05_pack/answer_cases.json` documents as each case's
...
in them comes from `data/day05_pack/` (synthetic training material per its own
...
def render_supported(case: dict, chunks: list[EvidenceChunk], result: GroundedAnswer) -> str:
    ...
    lines.append(
        ...
        f"(`{case['name']}`) in `data/day05_pack/answer_cases.json`, run through the real "
