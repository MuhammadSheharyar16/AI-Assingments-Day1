...
fixture in `tests/fixtures/day05/attacks/attack_fixtures.json`, then writes
...
synthetic text already committed in `tests/fixtures/day05/attacks/attack_fixtures.json`
...
FIXTURES_PATH = REPO_ROOT / "tests" / "fixtures" / "day05" / "attacks" / "attack_fixtures.json"
...
def render_report(rows: list[FixtureRow]) -> str:
    ...
    lines.append(
        ...
        f"`tests/fixtures/day05/attacks/attack_fixtures.json`. Every row runs the real "
